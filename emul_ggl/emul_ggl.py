...
class emul_ggl(Theory):
    ...
    def initialize(self):
        ...
        # BASIC CHECKS BEGINS ------------------------------------------------
        _required_lists = [
            ("extra", "Emulator ggl: Missing emulator file (extra) option"),
            ("ord", "Emulator ggl: Missing ord (parameter ordering) option"),
            ("file", "Emulator ggl: Missing emulator file option"),
            ("extrapar", "Emulator ggl: Missing extrapar option"),
        ]
        ...
        for i in range(imax):
            ...
            if not isinstance(self.extrapar[i], dict):
                raise ValueError('Emulator ggl: extrapar option not a dictionary')
        # BASIC CHECKS ENDS ------------------------------------------------
    ...
    def calculate(self, state, want_derived=True, **params):
        ...
        state["ggl"] = self.predict_data_vector(X,i)
        return True
