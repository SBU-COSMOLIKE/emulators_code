...
class emulbaores(BoltzmannBase):
    ...
    def initialize(self):
        ...
        self.model5 = ResMLP(input_dim=2, output_dim=96, int_dim=intdim_simple, N_layer=nlayer_simple)
    ...
    def calculate(self, state, want_derived=True, **params):
        ...
        vd = np.array([[cmb_param["omegabh2"], 
                            cmb_param["omegach2"],
                            cmb_param["H0"]]]) - self.extrainfo_rdrag.item()['X_mean']
